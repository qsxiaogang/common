...
public class WrapperAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public WrapperAdapter(RecyclerView.Adapter adapter, LinearLayout footerContainer,
    ...
    private boolean isFullSpanType(int type) {
        return type == FOOTER || type == LOAD_MORE_FOOTER;
    }
    ...
    public int getItemViewType(int position) {
        if (position == 0 && position == mAdapter.getItemCount()) return FOOTER;
