...
public class RegexUtils {
	...
	/**
	 * 匹配手机号码的正则表达式
	 * <br>支持130——139、150——153、155——159、170，177、180、183、185、186、188、189号段
	 */
	public static final String PHONE_NUMBER_REGEX = "^1{1}(3{1}\\d{1}|5{1}[012356789]{1}|7{1}[07]{1}|8{1}[035689]{1})\\d{8}$";
	 ...
	 * 匹配金额的正则表达式
	 */
	public static final String AMOUNT = "^\\d*\\.?\\d{0,2}$";
