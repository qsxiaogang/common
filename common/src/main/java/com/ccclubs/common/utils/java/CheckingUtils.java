 ...
 *
 * <br><b>1、Object相关验证</b>
 * <br>&nbsp;&nbsp;&nbsp;&nbsp;(1.01)、验证对象是否为空，为空的话抛出异常：static void valiObjectIsNull(Object object,
 * String objectName)
 * <br>
 * <br><b>2、String相关验证</b>
 * <br>&nbsp;&nbsp;&nbsp;&nbsp;(2.01)、验证字符串的长度是在指定范围内，不在的话抛出异常，忽略前后的空白符：static void
 * valiStringLength(String string, int minLength, int maxLength)
 * <br>&nbsp;&nbsp;&nbsp;&nbsp;(2.02)、验证字符串的长度的最小值，不合法的话抛出异常，忽略前后的空白符：static void
 * valiStringMinLength(String string, int minLength)
 * <br>&nbsp;&nbsp;&nbsp;&nbsp;(2.03)、验证字符串的长度的最大值，不合法的话抛出异常，忽略前后的空白符：static void
 * valiStringMaxLength(String string, int maxLength)
 * <br>
 * <br><b>3、int相关验证</b>
 * <br>&nbsp;&nbsp;&nbsp;&nbsp;(3.01)、验证Int型数据是在指定范围内，不在的话抛出异常：static valiIntValue(int number, int
 * minValue, int maxValue, String objectName)
 * <br>&nbsp;&nbsp;&nbsp;&nbsp;(3.02)、验证Int数据的最小值，不合法的话抛出异常：static void valiIntMinValue(int number,
 * int minValue, String objectName)
 * <br>&nbsp;&nbsp;&nbsp;&nbsp;(3.03)、验证Int数据的最大值，不合法的话抛出异常：static void valiIntMaxValue(int number,
 * int maxValue, String objectName)
 * <br>
 * <br><b>4、File相关验证</b>
 ...
 * <br>&nbsp;&nbsp;&nbsp;&nbsp;(4.04)、验证file是否是目录，不是的话抛出异常：static void valiFileIsDirectory(File
 * directory)
 * <br>&nbsp;&nbsp;&nbsp;&nbsp;(4.05)、验证file是否是文件，不是的话抛出异常：static void valiFileIsFile(File file)
 * <br>&nbsp;&nbsp;&nbsp;&nbsp;(4.06)、对指定的文件对象进行是否null、是否存在以及是否是文件校验，不合法的话抛出异常：static void
 * valiFile(File file)
 * <br>&nbsp;&nbsp;&nbsp;&nbsp;(4.07)、用于在执行读取之前对指定的文件对象进行是否null、是否存在、是否是文件以及能否读取校验，不合法的话抛出异常：static
 * void valiFileByReadBefore(File file)
 * <br>&nbsp;&nbsp;&nbsp;&nbsp;(4.08)、用于在执行写入之前对指定的文件对象进行是否null、是否存在、是否是文件以及能否写入校验，不合法的话抛出异常：static
 * void valiFileByWriteBefore(File file)
 */
public class CheckingUtils {
  ...
  public static void valiFileIsDirectory(File file) throws IllegalArgumentException {
    if (!file.isDirectory()) {
      throw new IllegalArgumentException(
          "File:'" + file.getName() + "'does not exist or not directory!");
    }
  }
  ...
  public static void valiFileIsFile(File file) throws IllegalArgumentException {
    if (!file.isFile()) {
      throw new IllegalArgumentException(
          "File:'" + file.getName() + "'does not exist or not file!");
    }
  }
